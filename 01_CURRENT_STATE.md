...
- Brain-Repo: `/home/zebra/projects/commandeur-brain` (Strategisches Cockpit)

## Technischer Rahmen
- HTML / CSS / JS (kein Framework, kein CMS)
- Obsidian-Vault & Auto-Pull aktiv.
- tmux-/Widget-Zugriff für LLM-Sessions eingerichtet.

## Tool-Routing
- **Codex**: Standard-Implementationen / Build.
- **Gemini**: Reviews / Diffs / Dokumentation.
